...
shutil.copytree(r'view\assets', os.path.join(dest_dir, 'assets'))
shutil.copytree('client', os.path.join(dest_dir, 'client'))
shutil.copytree('common', os.path.join(dest_dir, 'common'))
shutil.copytree('observer', os.path.join(dest_dir, 'observer'))
shutil.copytree('view', os.path.join(dest_dir, 'view'))